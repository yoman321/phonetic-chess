...
# Vendored modification: the upstream file's tail was a UCI-protocol stdin loop.
# We use Sunfish as a library (Position, Move, Searcher, parse/render), so the
# loop is gated behind __main__ to keep import side-effect-free.
